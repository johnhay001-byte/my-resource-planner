        ...
        <div className="w-full lg:w-[48rem] bg-white p-6 border-l border-gray-200 flex-shrink-0 overflow-y-auto">
            ...
            {activeTab === 'visualize' && (
                <div>
                    ...
                    <p className="text-gray-500">Controls for filtering and network views will go here.</p>
                </div>
            )}
            {activeTab === 'team' && (
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 mb-6 flex items-center"><UsersIcon className="h-6 w-6 mr-3" />Team Overview</h2>
                    <p className="text-gray-500">The sortable, editable table of team members will go here.</p>
                </div>
            )}
            {activeTab === 'manage' && (
                <div>
                    <h2 className="text-2xl font-bold text-gray-800 mb-6">Hierarchy Management</h2>
                    <p className="text-gray-500">Forms for adding clients, programs, and projects will go here.</p>
                </div>
            )}
        </div>
    );
