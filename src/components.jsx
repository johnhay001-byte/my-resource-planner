...
export const SidePanel = ({ data, allPeople, onPersonSelect, onUpdate, viewMode, networkFocus, setNetworkFocus, clients, programs }) => {
        ...
        <div className="w-full lg:w-[48rem] bg-white p-6 border-l border-gray-200 flex-shrink-0 overflow-y-auto">
            ...
            {activeTab === 'visualize' && (
                <div>
                    ...
                    {/* ... (Visualization content remains the same) */}
                </div>
            )}
